    ...
    <div class="home-container">
        ...
        <div class="search-container">
            ...
            <div class="options-form" id="options">
                ...
                <form action="" method="GET" style="visibility: hidden" id="submit-search"><input type="hidden" id="hidden-input" name="id" value=""></form>
            </div>
        </div>
        ...
        <div class="jumbotron home-option">
            ...
            <a class="btn btn-primary" href="/galleria/liste/listaQuadri.php" role="button">Sfoglia</a>
        </div>
        ...
        <div class="jumbotron home-option">
            ...
            <a class="btn btn-primary" href="/galleria/liste/listaAutori.php" role="button">Sfoglia</a>
        </div>
        ...
        <div class="jumbotron home-option">
            ...
            <a class="btn btn-primary" href="/galleria/liste/listaTecniche.php" role="button">Sfoglia</a>
        </div>
