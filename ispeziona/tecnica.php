...
<head>
    ...
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script><script src="../js/mainDetail.js"></script>
...
<script>
    initPage(<?php if(isset($_GET["id"])) echo $_GET["id"]; else echo "error";?>, "tecnica")
</script>
</html>