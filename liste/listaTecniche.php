...
<head>
    ...
    <script src="../js/mainListaTecniche.js"></script>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="/galleria/liste/listaTecniche.php">Tecniche</a>
                    </li>
                </ul>
            </div>
        </nav>

        <form class="list-container" id="list-container" action="../ispeziona/tecnica.php" method="GET">
